  ...
  return (
    <PhoneScreen title="SETTINGS EKRANI">
      ...
      <div style={{
        ...
        <SettingsRow label="Karanlık Mod" isToggle toggleOn={false} />
        <SettingsRow label="Font boyutu" value="Normal" hasArrow />

        <SectionHeader text="HESAP" />
        <SettingsRow label="Durum" value="Ücretsiz — 3/20 soru" />
        <SettingsRow
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ color: "#6A7A66", fontSize: "10px", marginTop: "4px" }}>
            Kalan: 3/20 günlük soru
          </div>
          <div style={{ color: "#3D6B35", fontSize: "9px", marginTop: "6px", fontWeight: "bold" }}>
            [!] Acil durumda SOS ile 72 saat full erişim + karanlık mod
          </div>
        </div>
        ...
        <div style={{
          ...
          {[
            { label: "Günlük soru", free: "20", premium: "Sınırsız" },
            { label: "SOS modu", free: "72 saat", premium: "Her zaman" },
            { label: "SOS → Karanlık mod", free: "✓", premium: "✓" },
        ...
        <div style={{
          ...
          <div style={{ fontSize: "11px", color: "#2A3428", lineHeight: "1.7" }}>
            ...
            <div style={{ marginBottom: "4px" }}>
              <span style={{ color: "#3D6B35", fontWeight: "bold" }}>[+]</span> SOS ile her zaman karanlık mod + pil tasarrufu
            </div>
            <div>
...
const SOSConfirmScreen = () => {
  return (
    <PhoneScreen title="SOS ONAY EKRANI">
      {/* Header */}
      <div style={{
        background: "linear-gradient(180deg, #A4AE9E 0%, #ACB6A8 100%)",
        ...
        <div style={{
          ...
          <button style={{
            ...
            border: "1px solid #E74C3C", borderRadius: "4px", padding: "3px 8px",
      ...
      {/* Dimmed chat background with overlay */}
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ padding: "16px 14px" }}>
            <div style={{
              color: "#2A3428", fontSize: "12px", lineHeight: "1.7",
            ...
            <div style={{
              ...
              <div style={{ fontSize: "10px", color: "#2A3428", lineHeight: "1.7" }}>
                <div style={{ marginBottom: "4px" }}>
                  <span style={{ color: "#3D6B35", fontWeight: "bold" }}>✓</span> 72 saat sınırsız soru
                </div>
                <div style={{ marginBottom: "4px" }}>
                  <span style={{ color: "#3D6B35", fontWeight: "bold" }}>✓</span> Karanlık mod (pil tasarrufu)
                </div>
                <div>
                  <span style={{ color: "#D67B37", fontWeight: "bold" }}>!</span> 30 günde 1 kez kullanılabilir
                </div>
              </div>
            </div>

            <div style={{
              color: "#6A7A66", fontSize: "9px", textAlign: "center",
            ...
            <div style={{ display: "flex", gap: "8px" }}>
              <button style={{
                ...
                border: "1px solid #A0AA96",
                borderRadius: "4px", padding: "10px",
                color: "#3A4A36", fontSize: "11px", fontWeight: "bold",
                fontFamily: "'Space Mono', monospace",
                letterSpacing: "1px", cursor: "pointer",
              }}>
                İPTAL
