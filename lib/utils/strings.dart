...
class AppStrings {
  ...
  static const AppStrings _tr = AppStrings._(
    ...
    onbReqStorage: '• ~2.3 GB boş depolama alanı',
    onbReqWifi: '• WiFi bağlantısı (önerilir)',
    onbReqDuration: '• İlk kurulum 5-20 dakika sürer',
    ...
    onbWifiDialogBody:
        'AI modeli yaklaşık 2.3 GB. WiFi olmadan indirme ücretlendirilebilir. Yine de devam etmek ister misin?',
  ...
  static const AppStrings _en = AppStrings._(
    ...
    onbReqStorage: '• ~2.3 GB free storage',
    onbReqWifi: '• WiFi connection (recommended)',
    onbReqDuration: '• First-time setup takes 5-20 minutes',
    ...
    onbWifiDialogBody:
        'The AI model is ~2.3 GB. Downloading without WiFi may incur charges. Continue anyway?',
